            ...
            <div class="col-lg-6">
                <div class="owl-carousel owl-theme s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="img/category/aa.jpg" alt="" />
                    </div>
                    <div class="single-prd-item">
                        <img class="img-fluid" src="img/category/dd.jpg" alt="" />
                    </div>
                    <div class="single-prd-item">
                        <img class="img-fluid" src="img/category/ee.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <div class="product_count">
                        <input type="text" name="qty1" id="sst1" maxlength="12" value="1" title="Quantity:" class="input-text qty1">
